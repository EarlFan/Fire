...
class Flux
{
  public:
    ...
    virtual void setBufferFlux2(){ Errors::errorMessage("setBufferFlux2 not available for required model"); };
    // virtual void setBufferFlux(Cell *cell, const int &numberPhases){ Errors::errorMessage("setBufferFlux not available for required model"); };
    ...
    // added for Fire
    virtual std::array<double,NS> getMassArray() const{ Errors::errorMessage("getMassArray not available for required model"); };

    virtual void prepSourceTermsReaction(Cell *cell, const double &dt, const int &numberPhases,std::shared_ptr<Cantera::Solution> sol_) { Errors::errorMessage("prepSourceTermsReaction not available for required model"); };
