...
Source::Source(const std::string &name) : m_name(name), m_order(1)
{}

//***********************************************************************

Source::Source(const std::string &name, int order) : m_name(name), m_order(order)
{}
...
void Source::integrateSourceTerms(Cell *cell, const int &numberPhases, const double &dt, std::shared_ptr<Cantera::Solution> sol_)
{
