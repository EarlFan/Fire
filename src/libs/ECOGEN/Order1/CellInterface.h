...
class CellInterface
{
  public:
    ...
    //Pour methode AMR
    virtual void computeXi(double lvl, double lvlHydro, double lvlChem, double lvlGeo, double T_threshhold, const double &criteriaVar, const bool &varRho, const bool &varP, const bool &varU, const bool &varT, const bool &varH2O, const bool &varAlpha);  /*!< Calcul de la variable Xi pour criteria de (de)raffinement a priori */
    void computeCritereAMR(double lvl, double lvlHydro, double lvlChem,  double lvlGeo, double T_threshhold, const double &criteriaVar, Variable nameVariable, int num = 0);  /*!< Calcul de xi via le criteria de variation */                                          /*!< Calcul de xi via le criteria de variation */
