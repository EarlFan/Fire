...
class Output
{
  public:
    ...
    virtual void setNumSortie(int restartTime)  { try { throw ErrorECOGEN("setNumSortie not available for requested output format"); } catch (ErrorECOGEN &) { throw; } };
  ...
  protected:
	...
	std::string m_folderRecorderGlobalQuantity;         //!<Folder to save recorded global quantity such as mass, energy
