...
if $RUN_AFTER_BUILD; then
    ...
    echo "Plotting 1D deflagration results in the case output dir ..."
    cp plot_1D_deflagration.py results/H2_Air_1D_deflagration/
    cd results/H2_Air_1D_deflagration/
    python plot_1D_deflagration.py
    cd ../../
else
